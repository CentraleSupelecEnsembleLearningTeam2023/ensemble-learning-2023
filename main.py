...
if __name__ == "__main__":
    ...
    X_train_encoded,y_train_encoded, X_test_encoded, y_test_encoded = preprocess_data(df, columns_to_keep=keepcolumns, cat_features=cat_features,
                                                   ...
                                                   test_size=0.2, vectorize_text = True, min_df = 2, outliers=False) 
    ...
    # lr, train_summary = train_linear_reg(X_train_encoded, X_test_encoded, y_train_encoded, y_test_encoded, cross_val = False,
                    # transform = True)
